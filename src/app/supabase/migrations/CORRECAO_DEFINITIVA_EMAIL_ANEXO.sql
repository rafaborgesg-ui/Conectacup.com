-- =====================================================
-- 🔥 CORREÇÃO DEFINITIVA - Envio de Planilha
-- =====================================================
-- Execute TODO este arquivo no Supabase SQL Editor
-- =====================================================

-- ⚠️ IMPORTANTE: Cole sua API Key do Resend na linha 24 antes de executar!
...
BEGIN
  ...
  -- 3. Montar lista completa de e-mails
...
<body>
  ...
  -- 6. Enviar e-mail com anexo via Resend usando pg_net
  -- 🔥 CORRIGIDO: Removido campo "type" que causava erro 400
...
-- =====================================================
-- O que foi corrigido:
-- ❌ ANTES: Campo "type" no anexo (causava erro 400)
-- ✅ AGORA: Apenas "filename" e "content" (formato correto Resend)
-- 
-- Próximo passo:
-- 1. Cole sua API Key na linha 24
-- 2. Execute TODO este SQL
