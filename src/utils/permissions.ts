...
import { MENU_STRUCTURE, MENU_TO_PAGE_MAP, getPagesByCategory, extractNavigablePages } from './menuStructure';
...
/**
 * Retorna categorias de páginas dinâmicas (usadas no AccessProfileManagement)
 * 
