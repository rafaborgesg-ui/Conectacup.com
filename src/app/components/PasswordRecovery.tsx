            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={`!pl-12 pr-12 bg-white/10 border-white/20 text-white placeholder:text-gray-400 transition-all !outline-none !ring-0 focus-visible:!outline-none focus-visible:!ring-0 focus:!outline-none focus:!ring-0 focus:!shadow-none ${
                    touched
